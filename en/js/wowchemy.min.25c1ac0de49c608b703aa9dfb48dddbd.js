...
See: https://github.com/francoischalifour/medium-zoom`);
      ...
      return Object.prototype.toString.call(t2) === "[object Object]" ? i2 = t2 : (t2 || typeof t2 == "string") && f2(t2), i2 = n({ margin: 0, background: "#fff", scrollOffset: 40, container: null, template: null }, i2), u2 = N(i2.background), document.addEventListener("click", F2), document.addEventListener("keyup", k2), document.addEventListener("scroll", S2), window.addEventListener("resize", l2), r2 = { open: g2, close: l2, toggle: v2, update: C2, clone: b2, attach: f2, detach: E2, on: O2, off: _2, getOptions: j2, getImages: x2, getZoomedImage: T2 }, r2;
    };
    function D(e2, t2) {
      t2 === void 0 && (t2 = {});
    ...
    z = ".medium-zoom-overlay{position:fixed;top:0;right:0;bottom:0;left:0;opacity:0;transition:opacity .3s;will-change:opacity}.medium-zoom--opened .medium-zoom-overlay{cursor:pointer;cursor:zoom-out;opacity:1}.medium-zoom-image{cursor:pointer;cursor:zoom-in;transition:transform .3s cubic-bezier(.2,0,.2,1)!important}.medium-zoom-image--hidden{visibility:hidden}.medium-zoom-image--opened{position:relative;cursor:pointer;cursor:zoom-out;will-change:transform}", D(z), T = w, F = true, f = "production", p = true;
    function q() {
      let e2 = [];
    ...
    if (window.addEventListener("hashchange", g), $("#navbar-main li.nav-item a.nav-link, .js-scroll").on("click", function(e2) {
      ...
      let e2 = $(".filter-search").keyup(V(function() {
    ...
    $(document).ready(function() {
      W(), q(), F && hljs.initHighlighting();
      let { isDarkTheme: n2, themeMode: s2 } = R();
      b(n2, s2, true);
